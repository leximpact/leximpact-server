...
class Dotations(object):
    ...
    def simule_dotations(**params: dict) -> tuple:
        ...
        prefix_dsr_next_year = "dsr_montant_annee_suivante_"
        prefix_annees_convergence = "annee_convergence_dsr_"
        df_results = simulate(request_body, prefix_dsr_eligible, prefix_dsr_montant, prefix_dsr_next_year)
        ...
        simulation_result = {
            "amendement": {
                "communes": {
                    ...
                    "df": build_response_dotations("amendement", df_results, "df", communes_cas_types=communes_cas_types, strates=strates)
                }
            },
            "base": {
                "communes": {
                    ...
                    "df": build_response_dotations("base", df_results, "df", communes_cas_types=communes_cas_types, strates=strates)
                }
            },
            "baseToAmendement": {
                "communes": {
